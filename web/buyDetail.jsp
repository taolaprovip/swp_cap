...
<body>
        <h1>sdkfdsklf</h1>
    <% List<Order> listOrderByUserID = (List<Order>) request.getAttribute("LIST_PRODUCT_BE_SELL_BY_SELLER_USERID");
        if (listOrderByUserID != null) { %>
    ...
    <form action="Maincontroller">
        ...
        <div class="basket">
            ...
            <%for (int i = 0; i < listOrderByUserID.size(); i++) {%>
            ...
            <div class="basket-product">
                ...
                <div class="quantity">
                    ...
                    <textarea><%=listOrderByUserID.get(i).getLocation()%></textarea>
        ...
        <aside>
            <div class="summary">
                ...
                <div class="summary-checkout">
                    <button class="checkout-cta" name="btAction" value="SellAll">Thu gom</button>
                </div>
            </div>
