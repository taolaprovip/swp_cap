            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!--                    <form class="d-flex mx-auto" action="Maincontroller" method="get" >
                                            ...
                                            <button class="btn btn-outline-su   ccess" type="submit" name="btAction" value="Search">Search</button>
                                        </form>
                    -->
                    ...
                    <a style="padding-right:  200px"> Xin chào <%=fullName %></a>  
                    ...
                    <form class="d-flex my-2"  action="Maincontroller">
                        <input type="hidden" name="userID" value="<%=loginUser.getUserID() %>">
                        <button class="btn btn-outline-dark" type="submit" name="btAction" value="Sell_Update">
                            <i class="bi-cart-fill me-1"></i>
                            Sell
                            <!--<span class="badge bg-dark text-white ms-1 rounded-pill">0</span>-->
                        </button>
